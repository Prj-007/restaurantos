  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 px-4">
      <div className="w-full max-w-sm rounded-xl border border-zinc-200 bg-white p-8 shadow-sm">
        <h1 className="text-xl font-semibold text-zinc-900">RestaurantOS</h1>
        ...
        <div className="mt-6 rounded-md bg-zinc-50 p-3 text-xs text-zinc-500">
          <p className="font-medium text-zinc-700">Demo accounts (password: password123)</p>
