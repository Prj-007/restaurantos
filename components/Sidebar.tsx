...
const NAV_ITEMS = [
  ...
  { href: "/audit-log", label: "Activity Log", icon: "📜" },
];
...
export default function Sidebar({ role }: { role: Role }) {
  ...
  return (
    <aside className="hidden w-60 shrink-0 border-r border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 sm:block">
      <div className="px-5 py-5">
        <span className="text-lg font-semibold tracking-tight text-zinc-900 dark:text-zinc-100">RestaurantOS</span>
      </div>
